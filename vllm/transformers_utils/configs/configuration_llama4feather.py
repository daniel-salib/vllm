#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/llama4feather/modular_llama4feather.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_llama4feather.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
class Llama4FeatherTextConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Llama4FeatherTextModel`]. It is used to instantiate a
    Llama4Feather text model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the Llama4Feather 109B.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 202048):
            Vocabulary size of the Llama4Feather text model. Defines the maximum number of different tokens that can be represented
            by the `inputs_ids` passed when calling [`Llama4FeatherTextModel`].
    ...
    def __init__(
        ...
        attn_temperature_tuning_floor=False,
        floor_scale=8192,
        attn_scale=1,
        yoco_local_kv_layer=None,
        yoco_global_kv_layer=None,
        cache_implementation="yoco_hybrid_chunked",
        **kwargs,
    ):
        super().__init__(
        ...
        if no_rope_layers == []:
            no_rope_layers = None
        default_no_rope_layers = None

        self.no_rope_layers = (
            no_rope_layers if no_rope_layers else default_no_rope_layers
        )
        self.attention_chunk_size = attention_chunk_size
        self.yoco_local_kv_layer = yoco_local_kv_layer
        self.yoco_global_kv_layer = yoco_global_kv_layer
        self.attn_temperature_tuning_floor = attn_temperature_tuning_floor


class Llama4FeatherVisionConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Llama4FeatherVisionModel`]. It is used to instantiate a
    Llama4Feather vision model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the Llama4Feather 109B.
    ...
    model_type = "llama4feather_vision_model"
...
class Llama4FeatherConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Llama4FeatherModel`]. It is used to instantiate an
    Llama4Feather model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the Llama4Feather 109B.
    ...
    Args:
        vision_config (`Llama4FeatherVisionConfig`, *optional*):
            The Llama4Feather Vision config.
        text_config (`Llama4FeatherTextConfig`, *optional*):
            The Llama4Feather Text config.
    ...
    ```python
    >>> from transformers import Llama4FeatherModel, Llama4FeatherConfig

    >>> # Initializing a Llama4Feather 7B style configuration
    >>> configuration = Llama4FeatherConfig()

    >>> # Initializing a model from the Llama4Feather 7B style configuration
    >>> model = Llama4FeatherModel(configuration)

    >>> # Accessing the model configuration
    >>> configuration = model.config
    ```"""

    model_type = "llama4feather"
    attribute_map = {
    ...
    sub_configs = {
        "text_config": Llama4FeatherTextConfig,
        "vision_config": Llama4FeatherVisionConfig,
    }
    base_model_tp_plan = {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if vision_config is None:
            self.vision_config = Llama4FeatherVisionConfig()
            logger.info(
                "vision_config is None, using default llama4feather vision config"
            )
        elif isinstance(vision_config, dict):
            self.vision_config = Llama4FeatherVisionConfig(**vision_config)
        elif isinstance(vision_config, Llama4FeatherVisionConfig):
        ...
        if text_config is None:
            self.text_config = Llama4FeatherTextConfig()
            logger.info("text_config is None, using default llama4feather text config")
        elif isinstance(text_config, dict):
            self.text_config = Llama4FeatherTextConfig(**text_config)
        elif isinstance(text_config, Llama4FeatherTextConfig):
